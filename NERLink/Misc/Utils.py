...
#    Revised: 07/19/2022                                                                   #
#                                                                                          #
#    Utilities Class For The NERLink Package.                                              #
#                                                                                          #
#    Authors:                                                                              #
#    --------                                                                              #
...
class Utils:
    ...
    """
        Retrieves All Directories And Files In Root Directory

        Inputs:
            root_path: Root Path (String)

        Outputs:
            dir_dict : Dictionary Containing Directory/File Structure
    """
    def Get_All_Files_And_Directories_In_Path( self, root_path ):
        directory_structure = {}

        for root, folders, files in os.walk( root_path ):
            if root not in directory_structure:
                directory_structure[root] = []

            for file in files:
                directory_structure[root].append( file )
