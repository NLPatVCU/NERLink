...
batch_size                 = 10
learning_rate              = 1e-5
train_bert_layer_weights   = False
use_csr_format             = True
lowercase                  = False
...
nerlink = NERLink( network_model = "concept_linking_bert", model_path = "./../dmis_lab_biobert_base_cased_v1.2",
                   margin = 30, scale = 0.05, use_csr_format = use_csr_format, lowercase = lowercase,
                   trainable_weights = train_bert_layer_weights, loss_function = loss_function, device_name = device_name,
                   ...
                   output_embedding_type = embedding_type, ignore_label_type_list = labels_to_skip )
...
predictions = nerlink.Predict( encoded_input = test_input, return_vector = True )
