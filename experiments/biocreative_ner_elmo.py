...
''' TODO: ELMoEmbeddingLayer batch size is fixed. If we specify a set number
          of instances != batch_size, this will result in an error. '''
...
# Model/Data Paths
model_path      = "./elmo_cdr_model_ep_10"
...
nerlink         = NERLink( network_model = "ner_elmo", model_path = "./../elmo_model/2", use_csr_format = use_csr_format,
                           trainable_weights = train_weights, loss_function = "categorical_crossentropy",
                           activation_function = "softmax", device_name = device_name, verbose = 1, batch_size = batch_size )
