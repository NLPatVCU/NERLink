#############################################################################
#                                                                           #
#  Trains NERLink's Stacked Bi-LSTM with user-specified embedding           #
#  representations and evaluates over the test data-set.                    #
#                                                                           #
#############################################################################
...
# Model/Data Paths
model_path      = "./test_bilstm_embedding_cdr_model_ep_40"
...
nerlink         = NERLink( network_model = "ner_bilstm", embedding_a_path = embedding_path, use_csr_format = use_csr_format,
                           trainable_weights = train_weights, loss_function = "categorical_crossentropy",
                           activation_function = "softmax", device_name = device_name, verbose = 2 )
